...
-(void)initialData
{
    ...
    self.voiceBtn=[self buttonWith:@"to_voice" hightLight:@"to_voice" action:@selector(voiceBtnPress:)];
...
//    [self addSubview:self.imageBtn];
    ...
    self.addBtn=[self buttonWith:@"btn_voice_send" hightLight:@"btn_voice_send_select" action:@selector(addBtnPress:)];
