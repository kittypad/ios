...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        _imageView = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"home.png"]];
        _imageView.center = CGPointMake(HomeImageWidth/2.0, frame.size.height/2.0);
        [self addSubview:_imageView];
        
        UILabel *label = [[UILabel alloc] initWithFrame:CGRectMake(HomeImageWidth, 0.0, frame.size.width - HomeImageWidth, frame.size.height)];
