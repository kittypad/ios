...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        [musicButton setImage:[UIImage imageNamed:@"音乐-左滑.png"] forState:UIControlStateNormal];
        ...
        [runningButton setImage:[UIImage imageNamed:@"计步-左滑.png"] forState:UIControlStateNormal];
        ...
        [weatherButton setImage:[UIImage imageNamed:@"天气-左滑.png"] forState:UIControlStateNormal];
