...
- (void)layoutSubviews
{
    ...
    self.textLabel.frame = CGRectMake(CGRectGetMaxX(self.imageView.frame) + vg, CGRectGetMinY(self.textLabel.frame), self.textLabel.frame.size.width, self.textLabel.frame.size.height);
}
